...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'h-[56px] px-2 rounded-lg font-semibold transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center'
